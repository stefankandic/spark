...
import org.apache.spark.sql.catalyst.plans.logical.{AnalysisOnlyCommand, CTEInChildren, CTERelationDef, LogicalPlan, Project, V1CreatePlan, View, WithCTE}
...
case class CreateViewCommand(
  ...
  extends RunnableCommand with AnalysisOnlyCommand with CTEInChildren with V1CreatePlan {
