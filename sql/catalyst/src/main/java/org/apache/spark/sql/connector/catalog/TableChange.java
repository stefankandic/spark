...
public interface TableChange {
  ...
  /**
   * Create a TableChange for changing collation for a table.
   *
   * @param collation name of the new collation
   * @return a TableChange for this assignment
   */
  static TableChange changeCollation(String collation) {
    return new ChangeCollation(collation);
  }
  ...
  /** A TableChange to alter collation for a table. */
  final class ChangeCollation implements TableChange {
    private final String collation;

    private ChangeCollation(String collation) {
    ...
    public boolean equals(Object o) {
      if (this == o) return true;
      if (o == null || getClass() != o.getClass()) return false;
      ChangeCollation that = (ChangeCollation) o;
